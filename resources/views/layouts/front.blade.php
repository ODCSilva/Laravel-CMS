...
<nav class="navbar navbar-default navbar-static-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <!-- Branding Image -->
            @if(Auth::user() && (Auth::user()->hasPrivilege('Admin') || Auth::user()->hasPrivilege('Editor')))
            ...
            <ul class="nav navbar-nav">
                ...
                @if (!empty($pages))
                    @foreach($pages as $page)
                        <li><a class="qtip-articles" id="{{$page->id}}" href="/page/{{$page->id}}">{{$page->alias}}</a></li>
                    @endforeach
                @endif
            </ul>
